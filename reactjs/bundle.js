...
var DragDrop = React.createClass({displayName: "DragDrop",
  ...
  getCheck: function() {
    return React.createElement("img", {style: styles.img, src: this.state.img});
  },
  reset: function() {
  ...
  getAnswers: function() {
    ...
    for(var i = 0; i < this.state.drop.length; i++) {
      ...
      x.push(React.createElement("div", {ref: d, key: d, style: styles.answers}, d))
    }
  ...
  getQuestions: function() {
    ...
    for(var i = 0; i < this.state.drag.length; i++) {
      ...
      x.push(React.createElement(QuestionCard, {text: d, key: d, coords: coords, ref: d}))
    }
    return React.createElement("div", null, x) 
  },
  render: function () {
...
React.render(React.createElement(DragDrop, null), document.getElementById('content'));
