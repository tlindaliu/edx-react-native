...
var Initializer = React.createClass({displayName: "Initializer",
  ...
  render: function() {
    return this.state.loaded ? React.createElement(DragDrop, {runtime: this.state.rtime, element: this.state.elem}) : React.createElement("div", {style: styles.container}, "Loading...")
  }
});

var DragDrop = React.createClass({displayName: "DragDrop",
  getInitialState: function() {
    this.coords = [];
    return {
      drop: [], 
  ...
  render: function () {
    return (
      React.createElement("div", {ref: "container", style: styles.container}, 
        React.createElement("div", {ref: "feedback", style: {
          borderWidth: 3,
          borderStyle: 'solid',
          borderColor: '#000',
          width: 300,
        ...
        onClick: this.onc}, this.state.feedback), 
        ...
        React.createElement("div", {ref: "buttons", style: styles.buttons}, 
          React.createElement("button", {onClick: this.submit}, "Submit"), 
          React.createElement("button", {onClick: this.reset}, "Reset"), 
          React.createElement("img", {style: styles.img, src: this.state.img})
        )
      )
    )
  }
...
React.render(React.createElement(Initializer, null), document.getElementById('content'));

},{"./QuestionCard":2,"react":157}],2:[function(require,module,exports){
'use strict';
var React = require('react');
